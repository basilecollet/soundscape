...
return [
    ...
    */
    ...
    'custom' => [
        'featuredImage' => [
            'dimensions' => 'L\'image principale doit faire au minimum 800x600 pixels.',
        ],
        'galleryImages' => [
            'max' => 'Vous pouvez télécharger un maximum de 10 images à la fois.',
        ],
        'galleryImages.*' => [
            'dimensions' => 'Chaque image de galerie doit faire au minimum 800x600 pixels.',
        ],
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'bandcamp_player' => 'lecteur Bandcamp',
        'bandcampPlayer' => 'lecteur Bandcamp',
