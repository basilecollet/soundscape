    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8 pb-6 border-b border-gray-200 dark:border-zinc-700">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-zinc-100">{{ __('admin.projects.management_title') }}</h1>
                    <p class="mt-2 text-gray-600 dark:text-zinc-400">{{ __('admin.projects.subtitle') }}</p>
                </div>
