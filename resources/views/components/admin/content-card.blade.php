...
<div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow duration-200">
    ...
    <div class="flex justify-between items-start mb-2">
        ...
        <!-- Page Badge (colored) -->
        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium shrink-0 {{ \App\PageBadgeColor::getClasses($content->page) }}">
    ...
    <div class="flex gap-2">
        ...
        @if($content->content)
            <flux:button
                ...
                "
                class="flex-1"
                :aria-label="copied ? 'Content copied to clipboard' : 'Copy {{ $content->key }} content to clipboard'"
            >
