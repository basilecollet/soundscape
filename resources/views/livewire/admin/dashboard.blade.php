<div class="space-y-8">
    <!-- Statistics Cards -->
    <div>
        <h2 class="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-6">{{ __('admin.dashboard.overview') }}</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ route('admin.content.index') }}" wire:navigate class="block group">
                <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-l-blue-500 cursor-pointer">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-sm font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mb-2 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">{{ __('admin.dashboard.stats.total_content') }}</h3>
                            ...
                            <p class="text-sm text-gray-600 dark:text-zinc-400 mt-1">{{ __('admin.dashboard.stats.content_pieces') }}</p>
                        </div>
            ...
            <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-l-green-500 group cursor-pointer">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mb-2 group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">{{ __('admin.dashboard.recent_messages.title') }}</h3>
                        ...
                        <p class="text-sm text-gray-600 dark:text-zinc-400 mt-1">{{ __('admin.dashboard.stats.unread_messages') }}</p>
                    </div>
            ...
            <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-6 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-l-purple-500 group">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-zinc-400 uppercase tracking-wide mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">{{ __('admin.dashboard.stats.last_update') }}</h3>
                        ...
                        <p class="text-sm text-gray-600 dark:text-zinc-400 mt-1">{{ __('admin.dashboard.stats.content_modified') }}</p>
                    </div>
    ...
    <div>
        <div class="flex items-center justify-between mb-6">
            <h2 class="text-xl font-semibold text-gray-900 dark:text-zinc-100">{{ __('admin.dashboard.recent_messages.title') }}</h2>
            <flux:button size="sm" variant="ghost" href="#">
                {{ __('admin.dashboard.recent_messages.view_all') }}
            </flux:button>
        </div>
                    ...
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 dark:text-zinc-400 mt-1">
                                {{ $message->subject ?? __('admin.dashboard.recent_messages.no_subject') }}
                            </p>
                            ...
                            <div class="flex items-center mt-2">
                                ...
                                <span class="text-xs text-green-600 dark:text-green-400 font-medium">{{ __('ui.status.new') }}</span>
                            </div>
                            @endif
                        </div>
                    </div>
    ...
    <div>
        <h2 class="text-xl font-semibold text-gray-900 dark:text-zinc-100 mb-6">{{ __('admin.dashboard.recent_messages.title') }}</h2>
        <div class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-700 rounded-xl p-12 text-center">
            ...
            <h3 class="text-lg font-medium text-gray-900 dark:text-zinc-100 mb-2">{{ __('admin.dashboard.recent_messages.empty_state') }}</h3>
            <p class="text-gray-500 dark:text-zinc-400">{{ __('admin.dashboard.recent_messages.empty_description') }}</p>
        </div>
    </div>
    @endif
</div>
