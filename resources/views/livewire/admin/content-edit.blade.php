<div>
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
            <div class="flex-1">
                @if($contentId)
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-2">Edit Content</h1>
                    @if($key && $page)
                        <p class="text-gray-600 dark:text-zinc-400">
                            Editing <code class="text-sm bg-gray-100 dark:bg-zinc-800 px-2 py-1 rounded font-mono">{{ $key }}</code>
                            on <span class="font-medium text-gray-800 dark:text-zinc-300">{{ ucfirst($page) }}</span> page
                        </p>
                    @endif
                @else
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-zinc-100 mb-2">Create New Content</h1>
                    <p class="text-gray-600 dark:text-zinc-400">Add new content to your website</p>
                @endif
            </div>
    ...
    <form wire:submit="save">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="flex items-center justify-between mt-2 text-xs text-gray-500 dark:text-zinc-400">
                        <div>
                            ...
                            @if(strlen($content) > 500)
                                <span class="text-amber-600 dark:text-amber-400 ml-2">• Long content</span>
                ...
                <div class="bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-700 pt-6 mt-6">
                    ...
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex items-center space-x-2 text-xs text-gray-500 dark:text-zinc-400">
                            💡 Press <kbd class="px-1.5 py-0.5 text-xs font-mono bg-gray-100 dark:bg-zinc-800 rounded">Ctrl+S</kbd> to save
                        </div>
                    </div>
            ...
            <!-- Preview Column -->
            <div class="space-y-6">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-zinc-100">Preview</h3>
                    ...
                    @else
                        <div class="flex items-center justify-center h-full text-center py-12">
                            <div class="space-y-3">
                                ...
                                <p class="text-gray-500 dark:text-zinc-400">Content preview will appear here...</p>
                            </div>
                        </div>
                    @endif
                </div>
