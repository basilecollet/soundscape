<div class="max-w-7xl mx-auto">
    ...
    @else
        ...
        <div class="hidden md:block bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-700 overflow-hidden">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center gap-3">
                                        @if($project->featuredImage)
                                            ...
                                            >
                                        @else
                                            <div class="w-16 h-12 bg-gray-100 dark:bg-zinc-800 rounded border border-gray-200 dark:border-zinc-700 flex items-center justify-center flex-shrink-0">
